...
type AdderClient interface {
	SendMessage(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error)
}
...
func (c *adderClient) SendMessage(ctx context.Context, in *AddRequest, opts ...grpc.CallOption) (*AddResponse, error) {
	out := new(AddResponse)
	err := c.cc.Invoke(ctx, "/myGRPC.Adder/SendMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AdderServer interface {
	SendMessage(context.Context, *AddRequest) (*AddResponse, error)
...
func (UnimplementedAdderServer) SendMessage(context.Context, *AddRequest) (*AddResponse, error) {
...
func _Adder_SendMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/myGRPC.Adder/SendMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AdderServer).SendMessage(ctx, req.(*AddRequest))
	}
